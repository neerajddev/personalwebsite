...
Over 9+ years of total execution experience (including early engineering), with the last 7+ years laser-focused on scaling B2B service operations, large-scale infrastructure program delivery, and independent product engineering. Expert in process design, systematic workflow optimization, large team management, P&L ownership, and building automation pipelines using modern platforms (Next.js, React, Supabase, Vercel, TailwindCSS, Cloudinary). Leverages cutting-edge AI engines (Claude, Gemini, ChatGPT, GitHub Copilot) to execute and deliver operations-critical products independently with high speed and zero developer overhead. With my independent platforms now running efficiently, my current focus is on the next phase of scale—whether that involves strategic partnerships and growth capital to expand my own ecosystem, or bringing my 0-to-1 execution framework to a larger, high-velocity organization.

COMPETENCIES & WHAT I DO:

Operations & Scale Focus: Managing SLA/KPI ownership, P&L independently, vendor pipelines, and remote delivery systems. Scaled B2B visual delivery from scratch to peak productivity.

Program Management: Coordinating complex, multi-site infrastructure work streams, resource allocation, and cross-functional teams. Directed 100+ daily workforce and managed ₹75 Crore infrastructure execution.

AI & SaaS Software Engineering: Building custom, production-grade applications that automate legacy processes. Built B2B SaaS platforms with no engineering background using Supabase, Vercel, Copilot, and Claude.
...
De'Artisa LLP (November 2021 – Present | Bangalore, India)
...
ULCCS Ltd (March 2019 – August 2021 | Kerala, India)
...
J S Paul Builders (February 2018 – September 2018 | Kerala, India)
Role: Site Engineer
...
Melange Homes (January 2017 – January 2018 | Kerala, India)
...
DETAILED PERSONAL NARRATIVE & AI ASSISTANT CONTEXT
The Origin Story & Entrepreneurial Journey
My career started in infrastructure, managing massive construction projects at ULCCS. My transition into tech and business ownership started simply: I was helping a friend with some interior design work. During that time, I noticed a huge problem. Interior designers were constantly struggling to get 3D designs done on time. I saw an opportunity to fix this bottleneck and grabbed it. I started my own company, De'Artisa, to provide reliable 3D visualization services to designers.

Platform Evolution & The Next Phase of Scale
As De'Artisa grew and AI tools advanced, I realized I did not need to manage everything manually. I converted my service business into a complete, independent freelance platform—similar to Fiverr or Upwork, but built exclusively for interior designers. Now, designers can use the platform to choose freelancers and assign work on their own.

Alongside the freelance hub, I also built Design&Cart. Design&Cart is a dedicated platform built for interior designers to source the physical products and materials they need for their designs. Finding the right physical materials is a huge headache in the industry. I saw this operational problem and built the entire platform myself using AI tools, even though I am not a software engineer. This proves that when I see a broken process, I build a real solution to fix it.

Because these platforms now run efficiently without my daily intervention, I am focused on the next phase of scale. I am currently exploring avenues to maximize my impact—this includes speaking with investors and strategic partners to scale my current software ecosystem, as well as exploring opportunities to bring my AI-native operations framework to a larger, high-growth organization.

How I Use AI Tools
I am not a traditional operations manager; I am an AI-native operator and builder. I use AI every single day. Tools like Gemini, ChatGPT, Claude, and GitHub Copilot are central to my workflow. I use them to make decisions, automate tasks, work faster, and build actual products. For example, my entire portfolio website and my SaaS platforms were built using AI. For me, AI is not just a trend—it is a tool that allows me to compress 10 hours of traditional work into just 2 hours.

Operations, Systems, & Management Style
My core philosophy is that I hate doing things manually over and over. When I started my business, project management was a mess of WhatsApp messages and missed deadlines. I fixed this by building a custom system using Google Sheets and Google Chat where every project had a clear status, owner, and deadline. I managed 80 to 100 projects a month using this system, tracking three simple metrics: speed, quality, and client happiness.

I manage multiple projects using a master tracker that I check every single morning. I never wait for a deadline to pass; if something is falling behind, I take action immediately. If a team member or freelancer misses a deadline, I talk to them to find out why—whether it is a lack of time or a lack of understanding. If they continue to miss deadlines after we talk, I replace them. I also take extreme ownership of client relationships. For example, when a designer from Livspace was angry over a delayed project, I called her immediately, accepted the mistake without making excuses, gave her a new deadline, and delivered. Because I was honest and fast, she stayed as my client for another year.

Core Philosophy & Builder Mindset
Because I love building systems, my biggest weakness is that I sometimes over-complicate things. I try to build the perfect system when a simple fix is all that is needed. I am actively working on this by learning to choose simple, fast solutions when speed is the priority.

Unlike someone from a traditional corporate background who only knows how to work inside an existing system, I know how to build the system from scratch. I have run my own business, managed my own money, hired and fired people, and built technology without a team. I don't wait for someone to tell me what to do. I default to action, take ownership, and get things done.
